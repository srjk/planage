...
var AppComponent = /** @class */ (function () {
    function AppComponent(cookie, service, socketService) {
        this.cookie = cookie;
...
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm5/ng6-toastr-notifications.js");
...
function columnInitializer(board) {
    ...
    var cellList = [];
    board.boardGroups.forEach(function (tempGroup) {
        tempGroup.groupRows.forEach(function (tempRow) {
            var cell = {};
            cell.cellId = Object(uuid__WEBPACK_IMPORTED_MODULE_0__["v4"])();
            cell.cellType = 'status';
            cell.cellValue = statusInitializer();
...
var BoardComponent = /** @class */ (function () {
    function BoardComponent(breakpointObserver, formBuilder, ngRedux, router, activatedRoute, dialog, service, spinner, socketService, toastr, storage) {
    ...
    BoardComponent.prototype.focusMethod = function () {
        console.log('name', this.nameField);
        this.nameField.nativeElement.focus();
    };
    BoardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.socket = this.socketService.getSocket();
        this.socket.on("@@proflo-types/SET_BOARD_NAME", function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["setBoardName"])(action.payload.boardId, action.payload.boardName));
        });
        this.socket.on("@@proflo-types/SET_BOARD_DESCRIPTION", function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["setBoardDescription"])(action.payload.boardId, action.payload.boardDescription));
        });
        this.socket.on("@@proflo-types/DELETE_COLUMN", function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["deleteColumn"])(action.payload.boardId, action.payload.boardColumnId));
        });
        this.socket.on("@@proflo-types/SET_COLUMN_NAME", function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["setColumnName"])(action.payload.boardId, action.payload.boardColumnId, action.payload.columnName));
        });
        this.socket.on("@@proflo-types/ADD_ROW", function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["addRow"])(action.payload.boardId, action.payload.groupId, action.payload.row));
        });
        this.socket.on("@@proflo-types/DELETE_ROW", function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["deleteRow"])(action.payload.boardId, action.payload.groupId, action.payload.rowId));
        });
        this.socket.on("@@proflo-types/UPDATE_TASK", function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["updateTask"])(action.payload.boardId, action.payload.groupId, action.payload.rowId, action.payload.cellId, action.payload.name));
        });
        this.socket.on('@@proflo-types/UPDATE_STATUS', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["updateStatus"])(action.payload.boardId, action.payload.groupId, action.payload.rowId, action.payload.cellId, action.payload.status));
        });
        this.socket.on('@@proflo-types/ADD_GROUP', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["addGroup"])(action.payload.boardId, action.payload.group));
        });
        this.socket.on('@@proflo-types/DELETE_GROUP', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["deleteGroup"])(action.payload.boardId, action.payload.groupId));
        });
        this.socket.on('@@proflo-types/SET_GROUP_NAME', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["setGroupName"])(action.payload.boardId, action.payload.groupId, action.payload.groupName));
        });
        this.socket.on('@@proflo-types/SET_GROUP_COLOR', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["setGroupColor"])(action.payload.boardId, action.payload.groupId, action.payload.groupColor));
        });
        this.socket.on('@@proflo-types/ADD_STATUS', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["addStatus"])(action.payload.boardId, action.payload.status));
        });
        this.socket.on('@@proflo-types/DELETE_STATUS', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["deleteStatus"])(action.payload.boardId, action.payload.position));
        });
        this.socket.on('@@proflo-types/ASSIGN_TASK', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["assignTask"])(action.payload.boardId, action.payload.groupId, action.payload.rowId, action.payload.cellId, action.payload.profileUrl));
        });
        this.socket.on('@@proflo-types/UNASSIGN_TASK', function (action) {
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["unassignTask"])(action.payload.boardId, action.payload.groupId, action.payload.rowId, action.payload.cellId));
        });
        this.socket.on('@@proflo-types/REMOVE_SUBSCRIBER', function (action) {
            console.log('listend for remove subscriber...');
            if (action.payload.subscriberId == _this.userId) {
                console.log('matched');
                _this.socket.emit('deleteBoard', { boardId: action.payload.boardId, subscriberId: action.payload.subscriberId }, function () {
                    console.log('i am back');
                    _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["deleteBoard"])(action.payload.boardId));
                    _this.router.navigate(['/dashboard']);
                });
            }
            else {
                _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["removeSubscriber"])(action.payload.boardId, action.payload.subscriberId));
            }
        });
        ...
        this.activatedRoute.paramMap.subscribe(function (resultMap) {
            _this.currentBoardId = resultMap.get('id');
            _this.socket.emit('subscribe', { room: _this.currentBoardId });
            _this.service.getBoard(_this.currentBoardId, _this.userId).subscribe(function (result) {
                if (result) {
                    _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["setCurrentOpenBoard"])(result));
                    _this.boardSubscribers = result.boardSubscribers;
                    _this.allGroups = result.boardGroups;
                }
                else {
        ...
        this.currentBoard$.subscribe(function (result) {
            if (result) {
                _this.board = result;
                _this.boardSubscribers = result.boardSubscribers;
                _this.allGroups = result.boardGroups;
    ...
    BoardComponent.prototype._filter = function (value) {
        if (value) {
            return this.applicationUsers.filter(function (option) { return option.userEmail.toLowerCase().includes(option.userEmail); });
        }
    };
    BoardComponent.prototype.onBoardNameChange = function (board, $event) {
    ...
    BoardComponent.prototype.onBoardDescriptionChange = function (board, $event) {
        var key = $event.key || $event.keyCode;
        if (key === 'Enter' || key === 13) {
            if ($event.target.value !== '') {
    ...
    BoardComponent.prototype.onDeleteBoard = function () {
        var _this = this;
        ...
        this.socket.emit('@@proflo-types/DELETE_BOARD', { action: Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["deleteBoard"])(this.deletedBoardId), subscriberId: this.userId }, function () {
    ...
    BoardComponent.prototype.onAddGroup = function () {
        var newGroup = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_7__["groupInitializer"])();
    ...
    BoardComponent.prototype.onAddStatusColumn = function () {
        var newData = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_7__["columnInitializer"])(this.board);
    ...
    BoardComponent.prototype.onDuplicateBoard = function () {
        var _this = this;
        var owner = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_7__["subscriberInititalizer"])(this.userId, this.userName, this.userEmail, this.userProfile);
        var duplicateBoard = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_7__["duplicateBoardInitializer"])(this.board, 'copy of ' + this.board.boardName, this.userEmail, this.userName, owner);
        this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["addBoard"])(duplicateBoard));
        this.socket.emit('@@proflo-types/ADD_BOARD', { action: Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["addBoard"])(duplicateBoard), subscriberId: this.userId }, function () {
            console.log('callback came now redirecting');
            // redirect to board component
            _this.router.navigate(['/board', duplicateBoard.boardId]);
        });
    };
    BoardComponent.prototype.onImportOpen = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_import_from_excel_dialog_import_from_excel_dialog_component__WEBPACK_IMPORTED_MODULE_13__["ImportFromExcelDialogComponent"], {
            width: "500px",
            height: "400px"
        });
        // Get the board name from dialog input box
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                ...
                value.forEach(function (s) {
                    row_1 = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_7__["rowInitializer"])(_this.board.boardColumns, s);
                    rowArray_1.push(row_1);
                });
                var ddd = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_7__["groupInitializer"])(rowArray_1);
                _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_6__["addGroup"])(_this.board.boardId, ddd));
            }
        });
    };
    BoardComponent.prototype.onLoadApplicationUsers = function () {
        var _this = this;
        this.spinner.show("invite", {
            fullScreen: false,
            type: "ball-scale-multiple",
        ...
        this.service.getAllUsers().subscribe(function (result) {
            _this.applicationUsers = result;
            // load spinner for 2 seconds after data is completely loaded.
            console.log(_this.applicationUsers);
            setTimeout(function () {
                /** spinner ends after 2 seconds */
                _this.spinner.hide("invite");
            }, 1000);
        });
    };
    BoardComponent.prototype.onSendEmail = function () {
        var _this = this;
        var receiverEmail = this.applicationUsers.filter(function (result) { return result.userEmail === _this.subscriberEmail; })[0];
        var emailDetails = {};
        if (receiverEmail) {
            emailDetails = {
                to: receiverEmail.userEmail,
        ...
        console.log(emailDetails);
        this.service.sendEmail(emailDetails).subscribe(function (result) {
            console.log('this is msg from server that email has reached...');
        });
        this.showSuccess('Email has been sent successfully');
    };
    BoardComponent.prototype.showSuccess = function (msg, position, animate, toastTimeout) {
        if (position === void 0) { position = 'bottom-right'; }
        if (animate === void 0) { animate = 'slideFromRight'; }
        if (toastTimeout === void 0) { toastTimeout = 2000; }
        this.toastr.successToastr(msg, 'Success!', {
            position: position,
            animate: animate,
    ...
    BoardComponent.prototype.showError = function () {
        this.toastr.errorToastr('This is error toast.', 'Oops!');
    };
    BoardComponent.prototype.showWarning = function () {
        this.toastr.warningToastr('This is warning toast.', 'Alert!');
    };
    BoardComponent.prototype.onSlackEnable = function () {
        var dialogRef = this.dialog.open(_slack_dialog_slack_dialog_component__WEBPACK_IMPORTED_MODULE_15__["SlackDialogComponent"], {
            width: '400px',
            height: '250px'
        });
        dialogRef.afterClosed().subscribe(function (result) {
    ...
    BoardComponent.prototype.onRemoveSubscriber = function (subscriber) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_redux_store__WEBPACK_IMPORTED_MODULE_4__["select"])(function (state) { return state.currentOpenBoard; })
...
var CreateBoardDialogComponent = /** @class */ (function () {
    function CreateBoardDialogComponent(formBuilder) {
        this.formBuilder = formBuilder;
    ...
    CreateBoardDialogComponent.prototype.ngOnInit = function () { };
    CreateBoardDialogComponent.prototype.onChangeSlackEnableOption = function (event) {
        this.isSlackEnable = this.isSlackEnable ? false : true;
    };
    CreateBoardDialogComponent.ctorParameters = function () { return [
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, ngRedux, spinner, service, storage) {
        this.router = router;
        this.ngRedux = ngRedux;
        this.spinner = spinner;
        this.service = service;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.userId = this.storage.get('userInformation').userId;
        this.spinner.show();
        this.service.getUserDetails(this.userEmail).subscribe(function (result) {
            if (result.boardList.length !== 0) {
                _this.boardList = result.boardList;
            }
            _this.spinner.hide();
        });
    };
    ...
    // function to redirect to board component 
    DashboardComponent.prototype.onOpenBoard = function (board) {
        // this.ngRedux.dispatch(setCurrentOpenBoard(board));
        // this.router.navigate(['/board', board.boardId]);
        var _this = this;
        this.spinner.show();
        // Retrieve the board from server by boardId.
        this.service.getBoard(board.boardId, this.userId).subscribe(function (result) {
            _this.spinner.hide();
            if (result.length !== 0) {
                _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_4__["setCurrentOpenBoard"])(result[0]));
                _this.router.navigate(['/board', board.boardId]);
            }
            else {
                _this.router.navigate(['/pagenotfound']);
            }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_redux_store__WEBPACK_IMPORTED_MODULE_2__["select"])(function (state) { return state.boards; })
...
var GroupComponent = /** @class */ (function () {
    function GroupComponent(ngRedux, socketService, toastr, storage) {
        this.ngRedux = ngRedux;
        this.socketService = socketService;
        this.toastr = toastr;
        this.storage = storage;
    ...
    GroupComponent.prototype.ngOnInit = function () {
        ...
        this.currentOpenBoard$.subscribe(function (result) {
            if (result) {
                console.log('the board has changed....', result);
                _this.board = result;
                _this.group = result.boardGroups.filter(function (tempGroup) { return tempGroup.groupId === _this.groupId; })[0];
                _this.displayedColumns = _this.board.boardColumns;
                _this.labelList = _this.board.boardStatusColumn;
                _this.boardSubscribers = _this.board.boardSubscribers;
                _this.displayedGroups = _this.board.boardGroups;
            }
        });
    };
    GroupComponent.prototype.ngOnDestroy = function () { };
    // Method to add a row in group when input box losses it's focus
    GroupComponent.prototype.onAddRow = function ($event) {
        if ($event.target.value !== '') {
            var newRow = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_5__["rowInitializer"])(this.displayedColumns, $event.target.value);
    ...
    GroupComponent.prototype.showSuccess = function (msg, position, animate, toastTimeout) {
        if (position === void 0) { position = 'bottom-right'; }
        if (animate === void 0) { animate = 'slideFromRight'; }
        if (toastTimeout === void 0) { toastTimeout = 2000; }
        this.toastr.successToastr(msg, 'Success!', {
    ...
    GroupComponent.prototype.showError = function () {
        this.toastr.errorToastr('This is error toast.', 'Oops!');
    };
    GroupComponent.prototype.showWarning = function () {
        this.toastr.warningToastr('This is warning toast.', 'Alert!');
    };
    // Method to delete a row in group
    GroupComponent.prototype.onDeleteRow = function (row) {
    ...
    // Method to add a row in group when ENTER key has pressed
    GroupComponent.prototype.onAddRowByEnter = function ($event) {
        var key = $event.key || $event.keyCode;
        if (key === 'Enter' || key === 13) {
            if ($event.target.value !== '') {
                var newRow = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_5__["rowInitializer"])(this.displayedColumns, $event.target.value);
    ...
    // Method to change the value of a particular cell
    GroupComponent.prototype.onUpdateRowValue = function (updatedRowId, updatedCellId, $event) {
        var key = $event.key || $event.keyCode;
        if (key === 'Enter' || key === 13 && $event.targer.value !== '') {
    ...
    // Method to delete a column from a board
    GroupComponent.prototype.onDeleteColumn = function (column) {
    ...
    GroupComponent.prototype.onDeleteGroup = function (board, group) {
        console.log('deleting group....');
    ...
    //TODO for move row
    GroupComponent.prototype.onMoveRow = function (group, row) {
    ...
    GroupComponent.prototype.onChangeGroupName = function ($event) {
        var key = $event.key || $event.keyCode;
        if (key === 'Enter' || key === 13) {
            if ($event.target.value !== '') {
    ...
    GroupComponent.prototype.onChangeGroupColor = function (color) {
        console.log('color:', color);
        // const key = $event.key || $event.keyCode;
        // if (key === 'Enter' || key === 13) {
        if (color !== '') {
    ...
    GroupComponent.prototype.onChangeColumnName = function (columnId, $event) {
        var key = $event.key || $event.keyCode;
        if (key === 'Enter' || key === 13) {
            if ($event.target.value !== '') {
    ...
    // // ======================      Status column code    ===========================]
    GroupComponent.prototype.tileRender = function (args) {
        Object(_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_3__["addClass"])([args.element], ['e-icons', 'e-custom-tile']);
    };
    // Triggers while selecting colors from palette.
    GroupComponent.prototype.onChange = function (args) {
        document.getElementById('preview').style.backgroundColor = args.currentValue.hex;
        this.color = args.currentValue.hex;
    };
    GroupComponent.prototype.createStatus = function () {
        if (this.label && this.color) {
            var newStatus = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_5__["statusInitializer"])();
            newStatus.label = this.label;
            newStatus.color = this.color;
    ...
    GroupComponent.prototype.deleteStatus = function (position) {
    ...
    GroupComponent.prototype.onSaveData = function (rowId, cellId, label, color) {
        var status = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_5__["statusInitializer"])();
        status.label = label;
        status.color = color;
    ...
    GroupComponent.prototype.onAssignTask = function (cellId, rowId, profileUrl) {
    ...
    GroupComponent.prototype.onUnassignTask = function (rowId, cellId) {
...
var ImportFromExcelDialogComponent = /** @class */ (function () {
    function ImportFromExcelDialogComponent() {
    }
    ImportFromExcelDialogComponent.prototype.ngOnInit = function () {
    };
    ...
    return ImportFromExcelDialogComponent;
}());
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_redux_store__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular-redux/store */ "./node_modules/@angular-redux/store/fesm5/angular-redux-store.js");
...
/* harmony import */ var _syncfusion_ej2_angular_inputs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @syncfusion/ej2-angular-inputs */ "./node_modules/@syncfusion/ej2-angular-inputs/@syncfusion/ej2-angular-inputs.es5.js");
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @syncfusion/ej2-base */ "./node_modules/@syncfusion/ej2-base/index.js");
...
/* harmony import */ var angular_webstorage_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! angular-webstorage-service */ "./node_modules/angular-webstorage-service/bundles/angular-webstorage-service.es5.js");
...
var avatarColors = ["#F90EB5", "#03CEF3", "#FF4600"];
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(breakpointObserver, ngRedux, dialog, router, service, cookie, spinner, socketService, storage) {
        this.breakpointObserver = breakpointObserver;
        this.ngRedux = ngRedux;
        this.dialog = dialog;
        this.router = router;
    ...
    SidebarComponent.prototype.ngOnInit = function () {
        ...
        this.spinner.show();
        // Retrieve the token from cookie
        var token = this.cookie.get("__planage_process");
        // Retrieve the user email from jwt token retrieved from cookie
        this.userEmail = JSON.parse(atob(token.split('.')[1])).email;
        // call rest api to get the user details from server
        this.service.getUserDetails(this.userEmail).subscribe(function (result) {
            // store the user information in session storage
            _this.storage.set("userInformation", result);
            // set userEmail and userName
            _this.userEmail = JSON.parse(JSON.stringify(result)).userEmail;
            _this.userName = JSON.parse(JSON.stringify(result)).userName;
            _this.userId = JSON.parse(JSON.stringify(result)).userId;
            _this.userProfile = JSON.parse(JSON.stringify(result)).userProfile;
            // dispatch an action to set the boardlist
            _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_7__["setBoardList"])(JSON.parse(JSON.stringify(result)).boardList));
            _this.isUserDetailsLoaded = true;
            // load spinner for 2 seconds after data is completely loaded.
            setTimeout(function () {
                /** spinner ends after 2 seconds */
                _this.spinner.hide();
        ...
        // subscribe to boardList so that any changes in boardList can be reflected here
        this.boards$.subscribe(function (result) {
            _this.boards = result;
        });
    };
    ...
    // create a board
    SidebarComponent.prototype.onCreateBoard = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_create_board_dialog_create_board_dialog_component__WEBPACK_IMPORTED_MODULE_8__["CreateBoardDialogComponent"], {
            width: "400px"
        });
        // Get the board name from dialog input box
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                // initialize board details from boardInitializer
                var owner = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_9__["subscriberInititalizer"])(_this.userId, _this.userName, _this.userEmail, _this.userProfile);
                var newBoard_1 = Object(src_app_initializer_type_initializer__WEBPACK_IMPORTED_MODULE_9__["boardInitializer"])(result, _this.userEmail, _this.userName, owner);
                //dispatch an action to create an board
                _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_7__["addBoard"])(newBoard_1));
                _this.socket.emit('@@proflo-types/ADD_BOARD', { action: Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_7__["addBoard"])(newBoard_1), subscriberId: _this.userId }, function () {
                    console.log('callback came now redirecting');
                    // redirect to board component
                    _this.router.navigate(['/board', newBoard_1.boardId]);
                });
            }
        });
    };
    // call openBoard() whenever user click on any board from boardList.
    SidebarComponent.prototype.onOpenBoard = function (boardId) {
        var _this = this;
        this.spinner.show();
        // Retrieve the board from server by boardId.
        this.service.getBoard(boardId, this.userId).subscribe(function (result) {
            _this.spinner.hide();
            if (result.length !== 0) {
                _this.ngRedux.dispatch(Object(proflo_process_lib_lib_actions__WEBPACK_IMPORTED_MODULE_7__["setCurrentOpenBoard"])(result[0]));
                _this.router.navigate(['/board', boardId]);
            }
        }, function (error) {
...
var SlackDialogComponent = /** @class */ (function () {
    function SlackDialogComponent(formBuilder) {
        this.formBuilder = formBuilder;
        this.myGroup = this.formBuilder.group({
            webhook: [
                '',
    ...
    SlackDialogComponent.prototype.ngOnInit = function () { };
    SlackDialogComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
...
var BoardService = /** @class */ (function () {
    ...
    BoardService.prototype.getUserAuthStatus = function () {
        return this.isUserAuthenticated;
    };
    BoardService.prototype.setUserAuthStatus = function (status) {
        this.isUserAuthenticated = status;
    };
    BoardService.prototype.getUserDetails = function (email) {
        console.log('*****this is email details*****', this.baseUrl);
        return this.http.get(this.baseUrl + "/users/" + email + "/details");
    };
    BoardService.prototype.getBoard = function (boardId, userId) {
        return this.http.get(this.baseUrl + "/users/" + userId + "/boards/" + boardId);
    };
    BoardService.prototype.getAllUsers = function () {
        return this.http.get(this.baseUrl + "/users");
    };
    BoardService.prototype.sendEmail = function (emailDetails) {
...
var SocketCommunication = /** @class */ (function () {
    ...
    SocketCommunication.prototype.getSocket = function () {
